...
st.markdown(f"""
    <h1> 
        <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="40px" fill="#F4A300">
...
st.divider()
st.markdown("""
     <div style="text-align:center; color:#8B4513; font-size:13px; padding:10px;">
        <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#F4A300">
